<?php
    ...
    // kita cek terlebih dahulu ketika tombol_submit ditekan
            ...
            <div class="col-md-6">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="gambar" id="gambar" placeholder="gambar" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
